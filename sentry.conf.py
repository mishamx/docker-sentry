...
# If you want to use YouTrack instance without valid ssl certificate add the following line to the sentry
YOUTRACK_VERIFY_SSL_CERTIFICATE = env('YOUTRACK_VERIFY_SSL_CERTIFICATE', False)
